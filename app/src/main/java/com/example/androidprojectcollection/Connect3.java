...
public class Connect3 extends AppCompatActivity {
    Button btncon;
        ...
        int player_coin = 1;
        int playerColor = android.R.color.holo_red_light;
                    ...
                    public void onClick(View view) {
                        ...
                        for (int i = 0; i < 10; i++) {
                            ...
                            if (coinChecker(target, ccol, player_coin, direction) == 3) {
                                ...
                                hasWon = true;
                                Toast.makeText(Connect3.this, WinMessage, Toast.LENGTH_SHORT).show();
                        ...
                        if (!hasWon) {
                            if (player_coin == 1) {
                                ...
                                player_coin = 1;
                                playerColor = android.R.color.holo_red_light;
                            }
